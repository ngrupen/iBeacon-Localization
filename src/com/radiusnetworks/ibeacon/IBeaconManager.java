...
public class IBeaconManager {
     ...
     */
    public static final long DEFAULT_FOREGROUND_SCAN_PERIOD = 210; //1100;
    /**
     ...
     */
    public static final long DEFAULT_BACKGROUND_SCAN_PERIOD = 5000; // was 10000
    /**
     ...
     */
    public static final long DEFAULT_BACKGROUND_BETWEEN_SCAN_PERIOD = 30*1000; // was 5*60*1000 = 5 minutes
